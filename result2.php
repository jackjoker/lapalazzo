<?php
    ...
    if(!isset($_POST['hid_apt_type']) || empty($_POST['hid_apt_type']))
    {
        ...
        <![endif]-->
            ...
            <div class="row">
                ...
                <h3 class="page_heading" id="enq_heading" style="">ENQUIRY</h3> 
                 ...
                 <p class="con_info">CONTACT INFORMATION<img src="img/plus.png" style="height:15px;"> 
                 </p>
                 
                 <p  class="con_info">
                 <a href="javascript:" onclick="history.go(-2)">  PERSONAL INFORMATION<img src="img/plus.png" style="height:15px;"> </a>
                 </p>

                 <p  class="con_info active">
                  <a href="javascript:" onclick="history.go(-1)">  PRICE CALCULATOR <img src="img/plus.png" style="height:15px;"> </a>
                 </p>
                ...
                <p id="text">Go back or click on the 'PRICE CALCULATOR' on the left pane to re-select.</p>
                </div>
                </div>
                ...
                <form action="result.html" method="post" name="contactform" id="contactform">
                  ...
                  <div class="row">
                    ...
                    <div class="span3" >
                      ...
                      <strong>
                        <?php echo $_POST['hid_apt_type'] ?>
                      </strong>

                     <!--  <select  name="apartment" id="apartment" class="required select_txt" disabled="disabled">
                     
                      <option value=""><font>I want a</font></option>
                     
                         <option value="3186"><font>3 BHK (3186 Sq.Ft) </font></option>
                          <option value="3300"><font>3 BHK + Family (3100 - 3500 Sq.Ft) </font></option>
                         <option value="4200"><font> 4 BHK + Family (4200  Sq.Ft)</font></option>
                         <option value="6442"><font>4 BHK + Family + Study - Duplex (6442  Sq.Ft)</font></option>
                     </select> -->
                       ...
                       <strong>
                        <?php echo $_POST['hid_floor'] ?>
                       </strong>
                       
                       <!-- <select  name="floor" id="floor" class="required select_txt" disabled="disabled">
                              <option value="7988"><font>3 BHK - 1st floor to 10th floor</font></option>
                              <option value="8150"><font>3 BHK + Family - 1st floor to 13th floor</font></option>
                              <option value="8230"><font>4 BHK + Family - 1st floor to 13th floor</font></option>
                       </select> -->
                    ...
                    <div class="span3" id="rate1">
                      <p id="rate">INR <?php echo $_POST['hid_price'] ?></p><p id="rate-content">*This is an approximate quote and</br>
               ...
               <div class="row">
                <div class="span8" id="do_you"><p>Do you wish to receive the plan for the selected apartment?</p>
                <p><a href=""><img src="img/btn_yes.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=""><img src="img/btn_no.png"></a></p>
                <p id="btm_content">* The plan and other information will be sent to your e-mail ID momentarily</p></div>
               </div>
