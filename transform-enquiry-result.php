...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Training - Kryptonite Supplements</title>
    ...
    <body>
        ...
        <div id="main_container" class="container-fluid">
                    ...
                    <div class="cnt_overlay"></div>

                    <div class="content_holder" style="padding-bottom:50px">
                        <div class="pdt_title col-md-8 regular center-block" style="padding-top:100px;text">
                            <div class="pdt_img_cnt">
                              
                                <div class="text_block_top_2 col-md-12 center-block" style="text-align:center">
								...
								<?php
                                    ...
                                    if($sent)
                                     echo "Thank you for your query. One of our experts will be in touch with you within the next 48 hours.";

                                        else
                                        echo '<h1>Error submitting</h1>';
                         ...
                         $HTML         = '<table cellspacing="0" cellpadding="8" border="0" width="600" style="background:#EEE">
                                   ...
                                   $from = "Kryptonite Website<info@ilovekryptonite.com>";
                                    $to = "info@ilovekryptonite.com, amantandon87@gmail.com";
                                    $subject = "Transformation Enquiry by ".$name;
