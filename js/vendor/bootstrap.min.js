...
"")),option=$(target).data("collapse")?"toggle":$this.data();if(!$(target).hasClass("in"))$(".accordion-heading .accordion-toggle").addClass("collapsed");$this[$(target).hasClass("in")?"addClass":"removeClass"]("collapsed");$(target).collapse(option)})}(window.jQuery);
