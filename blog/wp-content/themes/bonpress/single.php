			...
			?><div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="post_top">
					...
					<div class="meta clearfix">
						...
						if ( option::get('post_comm_count') == 'on' ) { ?><span class="comments"><?php comments_popup_link( __('0 comments', 'wpzoom'), __('1 comment', 'wpzoom'), __('% comments', 'wpzoom'), '', __('Comments are Disabled', 'wpzoom') ); ?></span><?php }
				...
				<?php if ( option::get('post_tags') == 'on' ) the_tags('<div class="meta clearfix"><p class="tags"><span class="fade">', '</span><span class="fade"> ', '</span></p></div>'); ?>
