...
<div id="welcome-panel" class="about-wrap">
	...
	<p class="about-text"> Binary is a free blog style WordPress theme. This is a WordPress 3+ ready theme with features like custom menu, featured images, widgetized sidebar etc. Theme also comes with an option panel. </p>
